...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Articles Project  ..Bootstrapped.</title>
  ...
  <body>
    ...
    <div class="container" id="index">
      ...
      <form id="setOffset" class="form-horizontal" action="./dostuff.php?action=index">
    ...
    <div class="container" id="details">
      ...
      <form id="updateForm" class="form-horizontal" action="./dostuff.php?action=update">
        <fieldset>
    ...
    <div class="container" id="add">
      ...
      <form id="addForm" class="form-horizontal" action="./dostuff.php?action=add">
        <fieldset>
